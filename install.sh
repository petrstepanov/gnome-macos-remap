...
gsettings set org.gnome.terminal.legacy.keybindings next-tab "['<Primary><Shift>Right']"
gsettings set org.gnome.terminal.legacy.keybindings prev-tab "['<Primary><Shift>Left']"
